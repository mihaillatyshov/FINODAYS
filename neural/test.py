...
df = pd.read_csv(r"C:\Users\ACER\Documents\Coding competitions\FINODAYS\neural\testdata.manual.2009.06.14.csv", sep="\t", comment='#')

# ml_index = pd.MultiIndex([0, 1, 2, 3, 4, 5])
# df = pd.read_csv(columns=ml_index)
df = pd.DataFrame(df)
